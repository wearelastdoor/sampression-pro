	...
	public static function register( $wp_customize ) {
        ...
        $wp_customize->add_panel( 'sampression_header_nav_panel', array(
            ...
            $wp_customize->add_section( 'sampression_title_tag_section',
                ...
                // $wp_customize->add_setting( 'header_font_size',
                //         array(
                //             'default' => 18,
                //             'transport' => 'postMessage'
                //         )
                //     );
                // $wp_customize->add_control(
                //     new Sampression_Fontsize_Control( $wp_customize, 'header_font_size',
                //         array(
                //             'type'        => 'range',
                //             'priority'    => 2,
                //             'section'     => 'sampression_title_tag_section',
            ...
            $wp_customize->add_section( 'sampression_secondarynav_section',
                ...
                $wp_customize->add_setting( 'sampression_secondary_nav', array('sanitize_callback' => 'sampression_sanitize_text'));
                $wp_customize->add_control( 'sampression_secondary_nav',
                        array(
                            'type' => 'checkbox',
        ...
        // Blog - Panel
        // $wp_customize->add_panel( 'sampression_blog_panel', array(
        //     'priority' => 50,
        //     'capability' => 'edit_theme_options',
        ...
        // ) );
            ...
            $wp_customize->add_section( 'sampression_blog_section',
                ...
                $wp_customize->add_setting( 'show_post_metas',
                        array(
                            'sanitize_callback' => 'sampression_sanitize_checkboxes',
                            'default' => '',//italic,underline
                            'transport' => 'postMessage'
                ...
                $wp_customize->add_control( new Sampression_Checkboxes_Control( $wp_customize, 'show_post_metas',
                    array(
                        'priority' => 1,
                        'settings' => 'show_post_metas',
